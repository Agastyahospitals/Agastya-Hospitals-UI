  ...
  const blogJsonLd = [
    {
      ...
      "publisher": {
        ...
        "logo": {
          "@type": "ImageObject",
          "url": "https://agastyahospitals.com/favicon.ico"
        }
      },
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 2,
          "name": "Blog",
          "item": "https://agastyahospitals.com/blog"
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": blogData.title,
          "item": `https://agastyahospitals.com/blog/${blogData.url}`
        }
      ]
    }
  ];
  ...
  return (
    <>
      <SEO
        ...
        description={blogData.metaDescription || `${blogData.title} - Health & Medical Blog by Agastya Hospitals, LB Nagar, Hyderabad.`}
        canonical={`/blog/${blogData.url}`}
        ogType="article"
        ogImage={blogData.postBanner}
        jsonLd={blogJsonLd}
      />
      <div className="container py-5">
        <div className="row m-0">
